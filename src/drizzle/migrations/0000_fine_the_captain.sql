CREATE TYPE "public"."course_section_statuses" AS ENUM('private', 'public');--> statement-breakpoint
CREATE TYPE "public"."lesson_statuses" AS ENUM('private', 'public', 'preview');--> statement-breakpoint
CREATE TYPE "public"."product_statuses" AS ENUM('private', 'public');--> statement-breakpoint
...
CREATE TABLE "course_sections" (
	...
	"courseId" uuid NOT NULL,
	"name" text NOT NULL,
	"status" "course_section_statuses" DEFAULT 'private' NOT NULL,
